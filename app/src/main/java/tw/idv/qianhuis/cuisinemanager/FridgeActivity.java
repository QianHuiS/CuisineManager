...
public class FridgeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_this= inflater.inflate(R.layout.activity_fridge, null);
                ...
                if(action == MotionEvent.ACTION_DOWN) {
                    ...
                    if(distance>300) {  //滑超過一定距離.
                        if(direciton>0) {   //若往右滑.
                            ...
                            intent.setClass(FridgeActivity.this, RecipeActivity.class);
        ...
        */
        ...
        //滑動
        gestureDetector=new GestureDetector(FridgeActivity.this, new GestureDetector.OnGestureListener() {
            @Override
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                x2= (int)e2.getX();  x1= (int)e1.getX();
                y2= (int)e2.getY();  y1= (int)e1.getY();
                ...
                if(distance>300) {  //滑超過一定距離.
                    if(direciton>0) {   //若往右滑.
                        Toast.makeText(FridgeActivity.this,"往右滑300!",Toast.LENGTH_SHORT).show();
                        /*Intent intent= new Intent();
                        intent.setClass(FridgeActivity.this, RecipeActivity.class);
                        startActivity(intent);*/
                    } else {    //若往左滑.
                        Toast.makeText(FridgeActivity.this,"往左滑300!",Toast.LENGTH_SHORT).show();
                        /*Intent intent= new Intent();
                        intent.setClass(FridgeActivity.this, RecipeActivity.class);
                        startActivity(intent);*/
                    }
    ...
    public void fridgeList(final String WHERE){ //把DB內容放入HashMap, 把HashMap放入ArrayList, 把ArrayList放入SimpleAdapter顯示.
        ...
        if(c1.getCount()==0) {   //若無資料, 顯示找不到資料及圖片.
            ...
            Toast.makeText(FridgeActivity.this, "沒有資料!!", Toast.LENGTH_SHORT).show();
        } else {    //若有資料, 將每筆資料取出.
            ...
            SimpleAdapter adapter= new SimpleAdapter(FridgeActivity.this,
                            ...
                            fDelete.setOnDismissListener(new DialogInterface.OnDismissListener() {
                                ...
                                public void onDismiss(DialogInterface dialog) {
                                    ...
                                    if(fDelete.getReturn().equals("")){
                                        Toast.makeText(FridgeActivity.this, "刪除失敗!?", Toast.LENGTH_SHORT).show();
                                    } else {
                                        mSQLiteDatabase.execSQL(fDelete.getReturn());
                                        fridgeList(WHERE); //刷新lv.
                                        Toast.makeText(FridgeActivity.this, "刪除成功!!", Toast.LENGTH_SHORT).show();
                                    }
                                    */
                                    fridgeList(WHERE); //刷新lv.
                                }
                            ...
                            fRevise.setOnDismissListener(new DialogInterface.OnDismissListener() {
                                ...
                                public void onDismiss(DialogInterface dialog) {
                                    ...
                                    if(fRevise.getReturn().equals("")){
                                        Toast.makeText(FridgeActivity.this, "修改失敗!?", Toast.LENGTH_SHORT).show();
                                    } else {
                                        mSQLiteDatabase.execSQL(fRevise.getReturn());
                                        fridgeList(WHERE); //刷新lv.
                                        Toast.makeText(FridgeActivity.this, "修改成功!!", Toast.LENGTH_SHORT).show();
                                    }
                                    */
                                    fridgeList(WHERE); //刷新lv.
                                }
                ...
                fAdd.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        ...
                        if(fAdd.getReturn().equals("")){
                            Toast.makeText(FridgeActivity.this, "新增失敗!?", Toast.LENGTH_SHORT).show();
                        } else {
                            mSQLiteDatabase.execSQL(fAdd.getReturn());
                            fridgeList(WHERE); //刷新lv.
                            Toast.makeText(FridgeActivity.this, "新增成功!!", Toast.LENGTH_SHORT).show();
                        }
                        */
                        fridgeList(WHERE); //刷新lv.
                    }
    ...
    private void setRecipeView() {
        setContentView(layout_this);  //切換至食譜畫面.
        layout_this= RECIPE;
        ...
        if(!recipeLoad) {
            ...
            layout_this.setOnTouchListener(new nextView());
